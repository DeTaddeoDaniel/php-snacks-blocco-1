<?php
    ...
    $testo = '
        ...
        Tuttavia, nessun argomento poteva persuadere il piccolo testo e quindi non passò molto tempo che due perfidi copywriter ne approfittarono, lo fecero ubriacare di longe e parole e lo trascinarono nella loro agenzia, dove abusarono di lui ripetutamente per i loro progetti. E se non fosse stato riscritto, lo sfrutterebbero ancora. In una terra lontana, dietro le montagne Parole, lontani dalle terre di Vocalia e Consonantia, vivono i testi casuali. Vivono isolati nella cittadina di Lettere, sulle coste del Semantico, un immenso oceano linguistico.
    ';
...
<head>
    ...
    <title>Uso di explode</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>

    <h1>uso di explode in un testo</h1>

    <h2>Esercizio: dividere il testo ad ogni punto, creando un nuovo paragrafo</h2>
        
    <h3>Testo iniziale</h3>
    <p><?php echo $testo; ?></p>

    <h3>Testo modificato: ogni punto corrispoden un nuovo paragrafo</h3>
    
    <?php     
        // crea nuovo array con separatore .
        $nuovoTesto = explode( '.', $testo ); 

        // stampa ogni p
        foreach ($nuovoTesto as $paragrafo) { ?>
